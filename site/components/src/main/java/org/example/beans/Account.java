...
@HippoEssentialsGenerated(internalName = "myproject:account")
@Node(jcrType = "myproject:account")
public class Account extends HippoCompound {

    public static final String TYPE = "myproject:type";
    public static final String LINK = "myproject:link";

    @HippoEssentialsGenerated(internalName = "myproject:type")
